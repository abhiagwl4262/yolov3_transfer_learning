...
class Bit_yolov3(torch.nn.Module):
    def __init__(self, darknet_model, backbone):
        ...
        self.mapping_layer1 = nn.Sequential(nn.BatchNorm2d(512), 
                                            nn.ReLU(), 
                                            nn.Conv2d(in_channels=512, out_channels=18, kernel_size=(1,1)))   # 512 to 18
        self.mapping_layer2 = nn.Sequential(nn.BatchNorm2d(1024), 
                                            nn.ReLU(),
                                            nn.Conv2d(in_channels=1024, out_channels=18, kernel_size=(1,1))) # 1024 to 18
        self.mapping_layer3 = nn.Sequential(nn.BatchNorm2d(2048), 
                                            nn.ReLU(),
